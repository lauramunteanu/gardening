...
Trois calendriers de jardin, consultables hors ligne :
...
- **Ce qui dure** (`arbustes.html`) — arbres et arbustes : fenêtres de taille,
  hivernage, reprise des jeunes plants

La page d'accueil laisse choisir entre les trois et rappelle, pour chacun, ce qu'il
...
- `data-potager.json`, `data-fleurs.json`, `data-arbustes.json` — **tout le contenu
  du jardin** ; ce sont les seuls fichiers à modifier pour ajouter une plante ou
  changer un mois
...
- `calendrier-cultures.html`, `calendrier-fleurs.html` — sources d'origine, conservées
  telles quelles et **non servies** : les modifier ne change rien sur le site
...
(`calendrier-v8` → `calendrier-v9`, …) pour que les appareils déjà visités récupèrent
la nouvelle version.
